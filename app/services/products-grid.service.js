...
(function () {
    ...
    angular.module('DealersApp')
         ...
         */
        .factory('ProductsGrid', ProductsGridFactory);

    ProductsGridFactory.$inject = ['$http', '$rootScope', 'Authentication'];
    function ProductsGridFactory($http, $rootScope, Authentication) {
