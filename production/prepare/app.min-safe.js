...
angular.module('DealersApp')
    .directive('intro', ["$mdMedia", function ($mdMedia) {
        return {
            restrict: 'E',
...
angular.module('DealersApp')
    ...
    .directive('ordersList', function () {
        return {
            ...
            controller: ["$scope", "$rootScope", "$location", "$mdDialog", "ActiveSession", "Purchase", "Product", "Translations", function ($scope, $rootScope, $location, $mdDialog, ActiveSession, Purchase, Product, Translations) {
...
angular.module('DealersApp')
    .directive('getStarted', function () {
        return {
            ...
            controller: ["$scope", "$location", "Dealer", "Dialogs", function ($scope, $location, Dealer, Dialogs) {
 ...
 */
    ...
    .directive('ngTranslateLanguageSelect', ["LocalesService", function (LocalesService) {
        'use strict';
        return {
            restrict: 'A',
            controller: ["$scope", function ($scope) {
...
angular.module('DealersApp')
    .service('LocalesService', ["$translate", "LOCALES", "$rootScope", "tmhDynamicLocale", function ($translate, LOCALES, $rootScope, tmhDynamicLocale) {
    'use strict';
...
angular.module('DealersApp')
    .service('Translations', ["$rootScope", "$translate", "tmhDynamicLocale", function ($rootScope, $translate, tmhDynamicLocale) {
        'use strict';
